...
public class RxBus {
    ...
    private Map<Object, List<Class<? extends Object>>> eventTypesBySubscriber = new HashMap<>();
    private Map<Class<? extends Object>, List<SubscriberMethod>> subscriberMethodByEventType = new HashMap<>();
    /*stick数据*/
        ...
        for (Method method : methods) {
            if (method.isAnnotationPresent(Subscribe.class)) {
                ...
                if (parameterType != null && parameterType.length == 1) {
                    ...
                    Class<? extends Object> eventType = parameterType[0];
     ...
     */
    private void addEventTypeToMap(Object subscriber, Class<? extends Object> eventType) {
        List<Class<? extends Object>> eventTypes = eventTypesBySubscriber.get(subscriber);
        if (eventTypes == null) {
     ...
     */
    private void addSubscriberToMap(Class<? extends Object> eventType, SubscriberMethod subscriberMethod) {
     ...
     * 用RxJava添加订阅者
     *
     * @param subscriberMethod 订阅模式，有：MAIN、NEW_THREAD、CURRENT_THREAD和IO
     */
     ...
     * @param subscriberMethod 订阅模式，有：MAIN、NEW_THREAD、CURRENT_THREAD和IO
     * @return 返回该事件源，也就是被观察者
     */
    private Observable postToObservable(Observable<? extends Object> observable, SubscriberMethod subscriberMethod) {
